      ...
      <section className="relative min-h-screen flex items-center justify-center pt-24 px-4 overflow-hidden">
        ...
        <div className="relative z-10 text-center max-w-5xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
            <Button size="lg" className="h-16 px-10 text-lg bg-white text-slate-950 hover:bg-slate-200 rounded-2xl shadow-2xl transition-all hover:-translate-y-1 font-bold">
              Daftar Sekarang <ChevronRight className="ml-2 h-5 w-5" />
            </Button>
